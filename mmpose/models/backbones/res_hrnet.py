...
class Res_HRNet(BaseBackbone):
    ...
    def init_weights(self):
        ...
        super(Res_HRNet, self).init_weights()
    ...
    def forward(self, x):
        ...
        for i in range(self.stage2_cfg['num_branches']):
            if self.transition1[i] is not None:
                ...
                Res.append(self.transition1[i](x))
            else:
                x_list.append(x)
        y_list = self.stage2(x_list)
        # y_list[0]=y_list[0]+Res[0]
        # Res.append(y_list[0])
        ...
        # y_list[0] = y_list[0] + Res[3]
        for i in range(1):
            y_list[i]=y_list[i]+Res[i]
        return tuple(y_list)
        # return (input_img,tuple(y_list))
        # return (tuple(y_list3),tuple(y_list))
