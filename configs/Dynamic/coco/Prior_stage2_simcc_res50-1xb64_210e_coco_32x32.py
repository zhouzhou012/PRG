...
#         custom_keys={
#             'model.E2': dict(lr_mult=1e-3),
#             'model.diffusion': dict(lr_mult=1e-3),
#         }))
...
# codec settings
codec = dict(
    type='Img_SimCCLabel', input_size=(32,32), sigma=1.0, simcc_split_ratio=4.0)
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True),
    s1_pretrained='/mnt/private/mmpose/work_dirs/PRG/Prior_stage1_simcc_res50-1xb64_210e_coco_32x32/20241117_113514_plan1_37.67/best_coco_AP_epoch_210.pth',
    backbone=dict(
        type='Dynamic_ResNet',
        depth=50,
            ),
