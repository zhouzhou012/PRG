...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True),
    s1_pretrained='/mnt/private/mmpose/work_dirs/PRG/Prior_stage1_simcc_hrnet_w48-1xb64_210e_coco_64x64/20241115_033409_plan1_64.49/best_coco_AP_epoch_210.pth',
    backbone=dict(
        type='Dynamic_HRNet',
        in_channels=3,
        extra=dict(
