...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True),
    s1_pretrained='/mnt/private/mmpose/work_dirs/PRG/Prior_stage1_simcc_hrnet_w32-1xb64_210e_coco_32x32/20241114_033519_plan1_45.72/best_coco_AP_epoch_210.pth',
    backbone=dict(
        type='Dynamic_HRNet',
        in_channels=3,
        extra=dict(
