...
from .base import Base_Img_KeypointCodec
import cv2
import numpy as np
...
class Img_UDPHeatmap(Base_Img_KeypointCodec):
    ...
    def encode(self,
        ...
        encoded = dict(heatmaps=heatmaps, keypoint_weights=keypoint_weights,img=img)
