...
class CPNHead(BaseHead):
    ...
    def predict(self,
        ...
        if test_cfg.get('flip_test', False):
            ...
            _,_batch_heatmaps = self.forward(_feats)
            _, _batch_heatmaps_flip = self.forward(_feats_flip)
            ...
            _,batch_heatmaps = self.forward(feats)
    ...
    def loss(self,
        ...
        """
        global_outs,pred_fields = self.forward(feats)
