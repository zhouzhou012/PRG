...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        bgr_to_rgb=True),
    s1_pretrained='/mnt/private/mmpose/work_dirs/PRG/Prior_stage1_simcc_hrnet_w32_wo-deconv-1xb64-210e_mpii-32x32/20241216_111500_63.85/best_PCK_epoch_210.pth',
    backbone=dict(
        type='Dynamic_HRNet',
        in_channels=3,
        extra=dict(
